...
class Table
{
     ...
     *
     */
    function __construct($align = self::CONSOLE_TABLE_ALIGN_LEFT,
                         $border = self::CONSOLE_TABLE_BORDER_ASCII, $padding = 1,
                         $charset = null)
    {
    ...
    /**
     * Converts array to table
     *
     * @param $headers
     * @param $data
     * @param bool|false $returnObject
     * @return bool|Table|string
     */
